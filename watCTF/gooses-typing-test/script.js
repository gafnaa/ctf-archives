(function() {
    ...
    if (fl && fl.supports && fl.supports("modulepreload"))
        return;
    ...
    function k(X) {
        const K = {};
        return X.integrity && (K.integrity = X.integrity),
        X.referrerPolicy && (K.referrerPolicy = X.referrerPolicy),
        X.crossOrigin === "use-credentials" ? K.credentials = "include" : X.crossOrigin === "anonymous" ? K.credentials = "omit" : K.credentials = "same-origin",
        K
    }
    function r(X) {
        if (X.ep)
...
function H1() {
    ...
    var _ = Symbol.for("react.transitional.element")
      ...
      , ul = Symbol.iterator;
    function Q(s) {
        return s === null || typeof s != "object" ? null : (s = ul && s[ul] || s["@@iterator"],
    ...
    function ou(s) {
        ...
        case "rejected":
            throw s.reason;
        default:
            switch (typeof s.status == "string" ? s.then(hu, hu) : (s.status = "pending",
            s.then(function(A) {
    ...
    function Hl(s, A, M, z, N) {
        ...
        if (G)
            ...
            Hl(N, A, M, "", function(Zt) {
                return Zt
            })) : N != null && (rt(N) && (N = Kl(N, M + (N.key == null || s && s.key === N.key ? "" : ("" + N.key).replace(Ot, "$&/") + "/") + G)),
            A.push(N)),
            1;
        G = 0;
        var Jl = z === "" ? "." : z + ":";
    ...
    x.cloneElement = function(s, A, M) {
        ...
        if (A != null)
            ...
            A)
                !Vl.call(A, G) || G === "key" || G === "__self" || G === "__source" || G === "ref" && A.ref === void 0 || (z[G] = A[G]);
    ...
    x.createElement = function(s, A, M) {
        ...
        if (A != null)
            ...
            A)
                Vl.call(A, z) && z !== "key" && z !== "__self" && z !== "__source" && (N[z] = A[z]);
        var G = arguments.length - 2;
        if (G === 1)
            N.children = M;
        else if (1 < G) {
    ...
    x.startTransition = function(s) {
        ...
        try {
            var z = s()
              , N = J.S;
            N !== null && N(M, z),
            typeof z == "object" && z !== null && typeof z.then == "function" && z.then(al, Y)
        } catch (w) {
            Y(w)
        } finally {
            J.T = A
...
function N1() {
    ...
    (function(_) {
                ...
                try {
                    l: {
                        ...
                        try {
                            t: {
                                for (dt(g),
                                ul = k(H); ul !== null && !(ul.expirationTime > g && pu()); ) {
                                    var al = ul.callback;
                                    if (typeof al == "function") {
                                        ul.callback = null,
                                        Q = ul.priorityLevel;
                                        var s = al(ul.expirationTime <= g);
                                        if (g = _.unstable_now(),
                                        typeof s == "function") {
                                            ul.callback = s,
                                            dt(g),
        ...
        ,
        _.unstable_scheduleCallback = function(g, O, Y) {
            var al = _.unstable_now();
            switch (typeof Y == "object" && Y !== null ? (Y = Y.delay,
            Y = typeof Y == "number" && 0 < Y ? al + Y : al) : Y = al,
            g) {
            case 1:
                var s = -1;
                break;
            ...
            Y > al ? (g.sortIndex = Y,
            fl(E, g),
            k(H) === null && g === k(E) && (yt ? (zt(Ll),
            Ll = -1) : yt = !0,
            Hl(J, Y - al))) : (g.sortIndex = s,
            fl(H, g),
            Bl || Yl || (Bl = !0,
            Vl || (Vl = !0,
            Rl()))),
...
function p1() {
    ...
    return pl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = r,
    pl.createPortal = function(H, E) {
    ...
    ,
    pl.preconnect = function(H, E) {
        typeof H == "string" && (E ? (E = E.crossOrigin,
    ...
    ,
    pl.preinit = function(H, E) {
        if (typeof H == "string" && E && typeof E.as == "string") {
            var U = E.as
              , ul = Ol(U, E.crossOrigin)
              , Q = typeof E.integrity == "string" ? E.integrity : void 0
              , Yl = typeof E.fetchPriority == "string" ? E.fetchPriority : void 0;
            U === "style" ? r.d.S(H, typeof E.precedence == "string" ? E.precedence : void 0, {
                crossOrigin: ul,
                integrity: Q,
                fetchPriority: Yl
            }) : U === "script" && r.d.X(H, {
    ...
    ,
    pl.preinitModule = function(H, E) {
        if (typeof H == "string")
            if (typeof E == "object" && E !== null) {
                if (E.as == null || E.as === "script") {
                    var U = Ol(E.as, E.crossOrigin);
                    r.d.M(H, {
                        crossOrigin: U,
    ...
    ,
    pl.unstable_batchedUpdates = function(H, E) {
        return H(E)
    }
    ,
    pl.useFormState = function(H, E, U) {
        return sl.H.useFormState(H, E, U)
    }
    ,
...
function B1() {
    ...
    var U = Object.assign
      ...
      , Ot = Symbol.iterator;
    function Rl(l) {
        return l === null || typeof l != "object" ? null : (l = Ot && l[Ot] || l["@@iterator"],
    ...
    var Ty = RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$")
      ...
      , mi = {};
    function Ey(l) {
        return Bn.call(mi, l) ? !0 : Bn.call(oi, l) ? !1 : Ty.test(l) ? mi[l] = !0 : (oi[l] = !0,
        !1)
    }
    function ze(l, t, u) {
        if (Ey(t))
...
` + u.stack
    ...
    function Jn(l, t, u, a, e, n, f, c) {
        ...
        t != null ? f === "number" ? (t === 0 && l.value === "" || l.value != t) && (l.value = "" + ut(t)) : l.value !== "" + ut(t) && (l.value = "" + ut(t)) : f !== "submit" && f !== "reset" || l.removeAttribute("value"),
        t != null ? wn(l, f, ut(t)) : u != null ? wn(l, f, ut(u)) : a != null && l.removeAttribute("value"),
        e == null && n != null && (l.defaultChecked = !!n),
        e != null && (l.checked = e && typeof e != "function" && typeof e != "symbol"),
        c != null && typeof c != "function" && typeof c != "symbol" && typeof c != "boolean" ? l.name = "" + ut(c) : l.removeAttribute("name")
    }
            ...
            case "input":
                ...
                u.type === "radio" && t != null) {
                    for (u = l; u.parentNode; )
                        u = u.parentNode;
                    for (u = u.querySelectorAll('input[name="' + at("" + t) + '"][type="radio"]'),
                    t = 0; t < u.length; t++) {
                        var a = u[t];
    ...
    function Ql(l) {
        function t(u, a, e, n, f) {
            ...
            for (var c in l)
                ...
                this[c] = u ? u(n) : n[c]);
            return this.isDefaultPrevented = (n.defaultPrevented != null ? n.defaultPrevented : n.returnValue === !1) ? He : Ui,
    ...
    var Su = {
        ...
        movementX: function(l) {
            return "movementX"in l ? l.movementX : (l !== Da && (Da && l.type === "mousemove" ? (lf = l.screenX - Da.screenX,
            tf = l.screenY - Da.screenY) : tf = lf = 0,
            Da = l),
            lf)
        },
    ...
    var Zy = U({}, Ma, {
        key: function(l) {
            ...
            l === 13 ? "Enter" : String.fromCharCode(l)) : l.type === "keydown" || l.type === "keyup" ? xy[l.keyCode] || "Unidentified" : ""
        },
        code: 0,
        location: 0,
        ctrlKey: 0,
    ...
    function xi(l, t, u, a) {
        ...
        t = bn(t, "onChange"),
        0 < t.length && (u = new Ne("onChange","change",null,u,a),
        l.push({
            event: u,
            listeners: t
        }))
    ...
    function Ci() {
        Ra && (Ra.detachEvent("onpropertychange", Vi),
        Ha = Ra = null)
    }
    function Vi(l) {
    ...
    function ed(l, t, u) {
        ...
        Ra = t,
        Ha = u,
        Ra.attachEvent("onpropertychange", Vi)) : l === "focusout" && Ci()
    }
    function nd(l) {
    ...
    function Wi(l, t, u) {
        ...
        qa && Na(qa, a) || (qa = a,
        a = bn(sf, "onSelect"),
        0 < a.length && (t = new Ne("onSelect","select",null,t,u),
        l.push({
            event: t,
            listeners: a
        }),
    ...
    var Ju = {
      ...
      , yf = {}
      , $i = {};
    Mt && ($i = document.createElement("div").style,
    "AnimationEvent"in window || (delete Ju.animationend.animation,
    ...
    function Dt(l, t) {
        var u = l.alternate;
        return u === null ? (u = kl(l.tag, t, l.key, l.mode),
    ...
    function Xe(l, t, u, a, e, n) {
        ...
        typeof l == "function")
            ...
            f = m1(l, u, N.current) ? 26 : l === "html" || l === "head" || l === "body" ? 27 : 5;
        else
            l: switch (l) {
            case rt:
                return l = kl(31, u, t, e),
                l.elementType = rt,
                l.lanes = n,
                l;
            case Bl:
            ...
            case yt:
                ...
                break;
            case Xl:
                return l = kl(12, u, t, e | 2),
                l.elementType = Xl,
                l.lanes = n,
                l;
            case J:
                return l = kl(13, u, t, e),
                l.elementType = J,
                l.lanes = n,
                l;
            case Vl:
                return l = kl(19, u, t, e),
                l.elementType = Vl,
                l.lanes = n,
                l;
            default:
    ...
    function rf(l, t, u) {
        return l = kl(6, l, null, t),
        l.lanes = u,
        l
    }
    function Sf(l, t, u) {
        return t = kl(4, l.children !== null ? l.children : [], l.key, t),
        t.lanes = u,
        t.stateNode = {
    ...
    function n0(l) {
        ...
        u = a.children,
        typeof u != "string" && typeof u != "number" && typeof u != "bigint" || t.textContent === "" + u || a.suppressHydrationWarning === !0 || Av(t.textContent, u) ? (a.popover != null && (V("beforetoggle", t),
        V("toggle", t)),
    ...
    function pa(l) {
        ...
        t === 13) {
            ...
            fu(l.type) ? (l = jc,
            jc = null,
            yl = l) : yl = t) : yl = Gl ? mt(l.stateNode.nextSibling) : null;
        return !0
    }
    function Ya() {
        yl = Gl = null,
    ...
    function c0() {
        var l = zu;
        return l !== null && (Cl === null ? Cl = l : Cl.push.apply(Cl, l),
        zu = null),
        l
    }
    function Ba(l) {
    ...
    function Va(l, t, u, a) {
        ...
        if (c !== null) {
            ...
            c = S.lastBaseUpdate,
            c !== f && (c === null ? S.firstBaseUpdate = h : c.next = h,
            S.lastBaseUpdate = i))
        }
        if (n !== null) {
            var T = e.baseState;
    ...
    function Td() {
        ...
        l = l.useState()[0],
        (P !== null ? P.memoizedState : null) !== l && (j.flags |= 1024),
        t
    }
    function Gf() {
        var l = we !== 0;
    ...
    function jl() {
        ...
        return rl === null ? j.memoizedState = rl = l : rl = rl.next = l,
        rl
    }
    function Sl() {
        if (P === null) {
    ...
    function Ka(l) {
        ...
        l = o0(ua, l, t),
        t = j,
        (rl === null ? t.memoizedState : rl.next) === null && (t = t.alternate,
    ...
    function Ja(l, t, u, a) {
        ...
        P !== null && a !== null && Yf(a, P.memoizedState.deps) ? e.memoizedState = aa(t, n, u, a) : (j.flags |= l,
        e.memoizedState = aa(1 | t, n, u, a))
    }
    function Q0(l, t) {
        Fe(8390656, 8, l, t)
    }
    ...
    function K0(l, t) {
        ...
        return t !== null && Yf(t, a[1]) ? a[0] : (u.memoizedState = [l, t],
        l)
    }
    function J0(l, t) {
        var u = Sl();
    ...
    function w0(l, t, u, a) {
        return $l(u, t) ? u : la.current !== null ? (l = Jf(l, u, a),
        $l(l, t) || (El = !0),
        l) : ($t & 42) === 0 ? (El = !0,
    ...
    var Pe = {
      ...
      , us = {
        ...
        useCallback: function(l, t) {
            return jl().memoizedState = [l, t === void 0 ? null : t],
            l
        },
        useContext: ql,
        useEffect: Q0,
        ...
        useCacheRefresh: function() {
            return jl().memoizedState = Od.bind(null, j)
        }
    }
      , as = {
        readContext: ql,
      ...
      , Md = {
        ...
        useOptimistic: function(l, t) {
            var u = Sl();
            return P !== null ? U0(u, P, l, t) : (u.baseState = l,
            [l, u.queue.dispatch])
        },
        useMemoCache: jf,
        useCacheRefresh: I0
    ...
    function ns(l) {
        ...
        function c(y, v, d, b) {
            return v === null || v.tag !== 6 ? (v = rf(d, y.mode, b),
            v.return = y,
            v) : (v = e(v, d),
            v.return = y,
            v)
        ...
        function i(y, v, d, b) {
            var D = d.type;
            return D === Bl ? S(y, v, d.props.children, b, d.key) : v !== null && (v.elementType === D || typeof D == "object" && D !== null && D.$$typeof === Kl && es(D) === v.type) ? (v = e(v, d.props),
            $a(v, d),
            v.return = y,
            v) : (v = Xe(d.type, d.key, d.props, null, y.mode, b),
            $a(v, d),
            v.return = y,
            v)
        }
        function h(y, v, d, b) {
            return v === null || v.tag !== 4 || v.stateNode.containerInfo !== d.containerInfo || v.stateNode.implementation !== d.implementation ? (v = Sf(d, y.mode, b),
            v.return = y,
            v) : (v = e(v, d.children || []),
            v.return = y,
            v)
        ...
        function S(y, v, d, b, D) {
            return v === null || v.tag !== 7 ? (v = Tu(d, y.mode, b, D),
            v.return = y,
            v) : (v = e(v, d),
            v.return = y,
            v)
        ...
        function B(y, v, d, b) {
            for (var D = null, Z = null, R = v, p = v = 0, zl = null; R !== null && p < d.length; p++) {
                R.index > p ? (zl = R,
                R = null) : zl = R.sibling;
                var W = o(y, R, d[p], b);
                if (W === null) {
            ...
            for (R = a(R); p < d.length; p++)
                zl = m(R, y, p, d[p], b),
                zl !== null && (l && zl.alternate !== null && R.delete(zl.key === null ? p : zl.key),
                v = n(zl, v, p),
                Z === null ? D = zl : Z.sibling = zl,
                Z = zl);
            return l && R.forEach(function(yu) {
                return t(y, yu)
            }),
            $ && Au(y, p),
            D
        ...
        function q(y, v, d, b) {
            if (d == null)
                throw Error(r(151));
            for (var D = null, Z = null, R = v, p = v = 0, zl = null, W = d.next(); R !== null && !W.done; p++,
            W = d.next()) {
                R.index > p ? (zl = R,
                R = null) : zl = R.sibling;
                var yu = o(y, R, W.value, b);
                if (yu === null) {
                    R === null && (R = zl);
                    break
                }
                l && R && yu.alternate === null && t(y, R),
                v = n(yu, v, p),
                Z === null ? D = yu : Z.sibling = yu,
                Z = yu,
                R = zl
            }
            if (W.done)
            ...
            W = d.next())
                W = m(R, y, p, W.value, b),
                W !== null && (l && W.alternate !== null && R.delete(W.key === null ? p : W.key),
                v = n(W, v, p),
                Z === null ? D = W : Z.sibling = W,
                Z = W);
            return l && R.forEach(function(D1) {
                return t(y, D1)
            }),
            $ && Au(y, p),
            D
            ...
            typeof d == "object" && d !== null) {
                ...
                case Q:
                    l: {
                        ...
                        d.type === Bl ? (b = Tu(d.props.children, y.mode, b, d.key),
                        b.return = y,
                        y = b) : (b = Xe(d.type, d.key, d.props, null, y.mode, b),
                        $a(b, d),
                        b.return = y,
                        y = b)
                    }
                ...
                if (typeof d.then == "function")
                    return tl(y, v, ln(d), b);
                if (d.$$typeof === Ul)
                    return tl(y, v, Ze(y, d), b);
                tn(y, d)
            }
    ...
    function kt(l) {
        ...
        z(bl, bl.current & 1),
        z(it, l),
        bt === null && (t === null || la.current !== null || t.memoizedState !== null) && (bt = l)
    }
    function cs(l) {
        if (l.tag === 22) {
            if (z(bl, bl.current),
    ...
    function is(l, t, u, a, e, n, f) {
        ...
        typeof l.shouldComponentUpdate == "function" ? l.shouldComponentUpdate(a, n, f) : t.prototype && t.prototype.isPureReactComponent ? !Na(u, a) || !Na(e, n) : !0
    }
    function ss(l, t, u, a) {
        l = t.state,
    ...
    function Dd(l, t, u, a, e) {
        ...
        a !== null && typeof a == "object" && typeof a.then == "function") {
            ...
            u !== null) {
                switch (u.tag) {
                case 13:
                    return bt === null ? Ac() : u.alternate === null && dl === 0 && (dl = 3),
                    u.flags &= -257,
                    u.flags |= 65536,
                    u.lanes = e,
    ...
    function gs(l, t, u, a, e) {
        if (l === null) {
            var n = u.type;
            return typeof n == "function" && !mf(n) && n.defaultProps === void 0 && u.compare === null ? (t.tag = 15,
            t.type = n,
            bs(l, t, n, a, e)) : (l = Xe(u.type, null, a, t, t.mode, e),
            l.ref = t.ref,
            l.return = t,
            t.child = l)
        }
    ...
    function Ts(l, t, u) {
        ...
        if (a.mode === "hidden") {
            ...
            n !== null ? (Ce(t, n.cachePool),
            b0(t, n),
            Ft(),
            t.memoizedState = null) : (l !== null && Ce(t, null),
            qf(),
            Ft());
        return _l(l, t, e, u),
        t.child
    ...
    function zs(l, t, u, a, e) {
        ...
        t.stateNode === null) {
            ...
            var h = n.context
              , S = u.contextType;
            f = $u,
            typeof S == "object" && S !== null && (f = ql(S));
            var T = u.getDerivedStateFromProps;
            S = typeof T == "function" || typeof n.getSnapshotBeforeUpdate == "function",
            c = t.pendingProps !== c,
            S || typeof n.UNSAFE_componentWillReceiveProps != "function" && typeof n.componentWillReceiveProps != "function" || (c || h !== f) && ss(t, n, a, f),
            Jt = !1;
            ...
            Ca(),
            h = t.memoizedState,
            c || o !== h || Jt ? (typeof T == "function" && (kf(t, u, T, a),
            h = t.memoizedState),
            (i = Jt || is(t, u, i, a, o, h, f)) ? (S || typeof n.UNSAFE_componentWillMount != "function" && typeof n.componentWillMount != "function" || (typeof n.componentWillMount == "function" && n.componentWillMount(),
            typeof n.UNSAFE_componentWillMount == "function" && n.UNSAFE_componentWillMount()),
            ...
            (h = typeof c == "function" || typeof n.getSnapshotBeforeUpdate == "function") || typeof n.UNSAFE_componentWillReceiveProps != "function" && typeof n.componentWillReceiveProps != "function" || (f !== T || o !== i) && ss(t, n, a, i),
            Jt = !1,
            o = t.memoizedState,
            n.state = o,
            Va(t, a, n, e),
            ...
            f !== T || o !== m || Jt || l !== null && l.dependencies !== null && je(l.dependencies) ? (typeof c == "function" && (kf(t, u, c, a),
            m = t.memoizedState),
            (S = Jt || is(t, u, S, a, o, m, i) || l !== null && l.dependencies !== null && je(l.dependencies)) ? (h || typeof n.UNSAFE_componentWillUpdate != "function" && typeof n.componentWillUpdate != "function" || (typeof n.componentWillUpdate == "function" && n.componentWillUpdate(a, m, i),
            ...
            n.state = m,
            n.context = i,
            a = S) : (typeof n.componentDidUpdate != "function" || f === l.memoizedProps && o === l.memoizedState || (t.flags |= 4),
            typeof n.getSnapshotBeforeUpdate != "function" || f === l.memoizedProps && o === l.memoizedState || (t.flags |= 1024),
            a = !1)
        }
        return n = a,
        ...
        t.flags |= 1,
        l !== null && a ? (t.child = na(t, l.child, null, e),
        t.child = na(t, null, u, e)) : _l(l, t, u, e),
    ...
    function _s(l, t, u) {
        ...
        h !== null ? e = Dt(h, e) : (e = Tu(e, c, u, null),
        e.flags |= 2),
        e.return = t,
        a.return = t,
        a.sibling = e,
    ...
    function Us(l, t, u) {
        if (l !== null)
            ...
            El = !1,
            $ && (t.flags & 1048576) !== 0 && e0(t, Qe, t.index);
        switch (t.lanes = 0,
        t.tag) {
        case 16:
            l: {
        ...
        case 26:
            return nn(l, t),
            l === null ? (u = qv(t.type, null, t.pendingProps, null)) ? t.memoizedState = u : $ || (u = t.type,
            l = t.pendingProps,
            ...
            Dl(a, u, l),
            Tl(a),
            t.stateNode = a) : t.memoizedState = qv(t.type, l.memoizedProps, t.pendingProps, l.memoizedState),
            null;
        case 27:
            return Yn(t),
            l === null && $ && (a = t.stateNode = Rv(t.type, t.pendingProps, G.current),
            Gl = t,
            gt = !0,
            e = yl,
            fu(t.type) ? (jc = e,
            yl = mt(a.firstChild)) : yl = e),
            _l(l, t, t.pendingProps.children, u),
            nn(l, t),
            l === null && (t.flags |= 4194304),
            t.child;
        case 5:
            return l === null && $ && ((e = a = yl) && (a = u1(a, t.type, t.pendingProps, gt),
            ...
            t.memoizedState !== null && (e = Bf(l, t, Td, null, null, u),
            ye._currentValue = e),
            nn(l, t),
            _l(l, t, a, u),
            t.child;
        case 6:
            return l === null && $ && ((l = u = yl) && (u = a1(u, t.pendingProps, gt),
        ...
        case 7:
            return _l(l, t, t.pendingProps, u),
            t.child;
        case 8:
            return _l(l, t, t.pendingProps.children, u),
            t.child;
        case 12:
            return _l(l, t, t.pendingProps.children, u),
            t.child;
    ...
    function Rs(l, t) {
        ...
        !Xv(t)) {
            if (t = it.current,
            t !== null && ((L & 4194048) === L ? bt !== null : (L & 62914560) !== L && (L & 536870912) === 0 || t !== bt))
                throw ja = Df,
                d0;
            l.flags |= 8192
        }
    ...
    function Rd(l, t, u) {
        ...
        case 3:
            ...
            (l === null || l.child === null) && (pa(t) ? Bt(t) : l === null || l.memoizedState.isDehydrated && (t.flags & 256) === 0 || (t.flags |= 1024,
            c0())),
            vl(t),
            null;
        case 26:
        ...
        case 6:
            if (l && t.stateNode != null)
                ...
                pa(t)) {
                    ...
                    l[Nl] = t,
                    l = !!(l.nodeValue === u || a !== null && a.suppressHydrationWarning === !0 || Av(l.nodeValue, u)),
                    l || Ou(t)
                } else
        ...
        case 4:
            return Zt(),
            l === null && Nc(t.stateNode.containerInfo),
            vl(t),
            null;
        case 10:
            return Nt(t.type),
            ...
            n === null)
                        ...
                        for (l = t.child; l !== null; ) {
                            ...
                            n !== null) {
                                ...
                                u = t.child; u !== null; )
                                    a0(u, l),
                                    u = u.sibling;
                                return z(bl, bl.current & 1 | 2),
                                t.child
                            }
                            l = l.sibling
                        }
                    e.tail !== null && St() > yn && (t.flags |= 128,
                    a = !0,
                    ka(e, !1),
                    t.lanes = 4194304)
                }
                ...
                if (!a)
                    ...
                    l !== null) {
                        ...
                        2 * St() - e.renderingStartTime > yn && u !== 536870912 && (t.flags |= 128,
                        a = !0,
                        ka(e, !1),
                        t.lanes = 4194304);
        ...
        case 23:
            ...
            a ? (u & 536870912) !== 0 && (t.flags & 128) === 0 && (vl(t),
    ...
    function qs(l, t, u) {
        u.props = Ru(l.type, l.memoizedProps),
    ...
    function Xs(l, t, u) {
        ...
        case 22:
            ...
            !a) {
                ...
                var n = ol;
                Gt = a,
                (ol = t) && !n ? lu(l, u, (u.subtreeFlags & 8772) !== 0) : Pt(l, u),
                Gt = e,
                ol = n
            }
            break;
    ...
    function Qs(l, t, u) {
        ...
        case 18:
            il !== null && (Zl ? (l = il,
            Dv(l.nodeType === 9 ? l.body : l.nodeName === "HTML" ? l.ownerDocument.body : l, u.stateNode),
            me(l)) : Dv(il, u.stateNode));
            break;
        case 4:
            a = il,
            e = Zl,
    ...
    function qd(l) {
        ...
        case 19:
            var t = l.stateNode;
            return t === null && (t = l.stateNode = new Gs),
            t;
        case 22:
            return l = l.stateNode,
            t = l._retryCache,
    ...
    function Zs(l, t) {
        ...
        case 26:
            ...
            a & 4) {
                ...
                u === null)
                        ...
                        if (l.stateNode === null) {
                            l: {
                                ...
                                case "title":
                                    ...
                                    (!n || n[Aa] || n[Nl] || n.namespaceURI === "http://www.w3.org/2000/svg" || n.hasAttribute("itemprop")) && (n = e.createElement(a),
                    ...
                    a === null ? Gv(e, l.type, l.stateNode) : Yv(e, a, l.memoizedProps)) : a === null && l.stateNode !== null && cc(l, l.memoizedProps, u.memoizedProps)
            }
            break;
        case 27:
            Fl(t, l),
        ...
        case 13:
            Fl(t, l),
            Il(l),
            l.child.flags & 8192 && l.memoizedState !== null != (u !== null && u.memoizedState !== null) && (Sc = St()),
            a & 4 && (a = l.updateQueue,
    ...
    function Vs(l, t, u, a) {
        ...
        case 22:
            n = t.stateNode,
            f = t.alternate,
            t.memoizedState !== null ? n._visibility & 2 ? Et(l, t, u, a) : Pa(l, t) : n._visibility & 2 ? Et(l, t, u, a) : (n._visibility |= 2,
    ...
    function fa(l, t, u, a, e) {
        ...
        t = t.child; t !== null; ) {
            ...
            case 22:
                var S = f.stateNode;
                f.memoizedState !== null ? S._visibility & 2 ? fa(n, f, c, i, e) : Pa(n, f) : (S._visibility |= 2,
                fa(n, f, c, i, e)),
    ...
    function Ls(l) {
        ...
        case 26:
            ca(l),
            l.flags & le && l.memoizedState !== null && S1(ot, l.memoizedState, l.memoizedProps);
            break;
        case 5:
            ca(l);
            break;
        ...
        case 22:
            ...
            t !== null && t.memoizedState !== null ? (t = le,
            le = 16777216,
            ca(l),
            le = t) : ca(l));
            break;
    ...
    function tt(l, t, u) {
        (l === nl && (I === 2 || I === 9) || l.cancelPendingCommit !== null) && (da(l, 0),
        nu(l, L, st, !1)),
        Ea(l, u),
        ((F & 2) === 0 || l !== nl) && (l === nl && ((F & 2) === 0 && (Nu |= u),
        dl === 4 && nu(l, L, st, !1)),
        At(l))
    }
    function ks(l, t, u) {
        ...
        do {
            if (e === 0) {
                ...
                l: {
                    ...
                    if ((t & 62914560) === t && (e = Sc + 300 - St(),
                    10 < e)) {
                        if (nu(a, t, st, !tu),
                        Ae(a, 0, !0) !== 0)
                            break l;
                        a.timeoutHandle = _v(Fs.bind(null, a, u, Cl, dn, rc, t, st, Nu, sa, tu, n, 2, -0, 0), e);
                        break l
                    }
                    Fs(a, u, Cl, dn, rc, t, st, Nu, sa, tu, n, 0, -0, 0)
                }
            }
            break
        } while (!0);
    ...
    function Fs(l, t, u, a, e, n, f, c, i, h, S, T, o, m) {
        ...
        T = g1(),
        T !== null)) {
            l.cancelPendingCommit = T(ev.bind(null, l, t, n, u, a, e, f, c, i, S, 1, o, m)),
            nu(l, n, f, !h);
            return
        }
    ...
    function Is(l, t) {
        ...
        t === Qa || t === Ve ? (t = m0(),
        I = 3) : t === d0 ? (t = m0(),
        I = 4) : I = t === rs ? 8 : t !== null && typeof t == "object" && typeof t.then == "function" ? 6 : 1,
        Pl = t,
        C === null && (dl = 1,
        en(l, et(t, l.current)))
    }
    ...
    function Ac() {
        dl = 4,
        tu || (L & 4194048) !== L && it.current !== null || (ia = !0),
        (uu & 134217727) === 0 && (Nu & 134217727) === 0 || nl === null || nu(nl, L, st, !1)
    }
    function zc(l, t, u) {
        var a = F;
        F |= 2;
    ...
    function ha(l, t, u, a) {
        ...
        t.flags & 32768 ? ($ || a === 1 ? l = !0 : ia || (L & 536870912) !== 0 ? l = !1 : (tu = l = !0,
        (a === 2 || a === 9 || a === 3 || a === 6) && (a = it.current,
    ...
    function cv() {
        if (Ml === 4 || Ml === 3) {
            ...
            At(l),
            e = l.pendingLanes,
            (u & 4194090) !== 0 && (e & 42) !== 0 ? l === Tc ? ae++ : (ae = 0,
            Tc = l) : ae = 0,
            ee(0)
        }
    }
    ...
    function Qd(l, t, u) {
        ...
        l.warmLanes &= ~u,
        nl === l && (L & u) === u && (dl === 4 || dl === 3 && (L & 62914560) === L && 300 > St() - Sc ? (F & 2) === 0 && da(l, 0) : mc |= u,
        sa === L && (sa = 0)),
        At(l)
    }
    function yv(l, t) {
    ...
    var rn = null
      ...
      , qu = 0;
    function At(l) {
        l !== oa && l.next === null && (oa === null ? rn = oa = l : oa = oa.next = l),
        Sn = !0,
        _c || (_c = !0,
        Ld())
    }
            ...
            do
                for (var u = !1, a = rn; a !== null; ) {
                    if (l !== 0) {
                        ...
                        n = L,
                        n = Ae(a, a === nl ? n : 0, a.cancelPendingCommit !== null || a.timeoutHandle !== -1),
                        (n & 3) === 0 || Ta(a, n) || (u = !0,
                        mv(a, n));
                    a = a.next
                }
    ...
    function ov(l, t) {
        ...
        if (mn() && l.callbackNode !== u)
            return null;
        var a = L;
        return a = Ae(l, l === nl ? a : 0, l.cancelPendingCommit !== null || l.timeoutHandle !== -1),
        a === 0 ? null : (ks(l, a, t),
        hv(l, St()),
    ...
    function Kd(l, t, u, a, e) {
        if (t === "submit" && u && u.stateNode === e) {
            var n = rv((e[xl] || null).action)
              , f = a.submitter;
            f && (t = (t = f[xl] || null) ? rv(t.formAction) : f.getAttribute("formAction"),
            t !== null && (n = t,
            f = null));
    ...
    var ne = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" ")
      , Wd = new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(ne));
    function gv(l, t) {
        t = (t & 4) !== 0;
    ...
    function Nc(l) {
        if (!l[gn]) {
            ...
            di.forEach(function(u) {
                u !== "selectionchange" && (Wd.has(u) || Hc(u, !1, l),
                Hc(u, !0, l))
            });
        ...
        Mi(function() {
            ...
            l: {
                ...
                if (o !== void 0) {
                    ...
                    for (var v = h, d; v !== null; ) {
                        ...
                        if (d = b.stateNode,
                        b = b.tag,
                        b !== 5 && b !== 26 && b !== 27 || d === null || y === null || (b = Oa(v, y),
                        b != null && q.push(fe(v, b, d))),
                        tl)
                            break;
                        v = v.return
                    }
                    0 < q.length && (o = new m(o,B,null,u,S),
                    T.push({
                        event: o,
                        listeners: q
                    }))
            ...
            if ((t & 7) === 0) {
                l: {
                    ...
                    o && u !== $n && (B = u.relatedTarget || u.fromElement) && (Bu(B) || B[Yu]))
                        break l;
                    if ((m || o) && (o = S.window === S ? S : (o = S.ownerDocument) ? o.defaultView || o.parentWindow : window,
                    m ? (B = u.relatedTarget || u.toElement,
                    m = h,
                    B = B ? Bu(B) : null,
                    B !== null && (tl = K(B),
                    q = B.tag,
                    B !== tl || q !== 5 && q !== 27 && q !== 6) && (B = null)) : (m = null,
                    B = h),
                    m !== B)) {
                        if (q = Ri,
                        b = "onMouseLeave",
                        y = "onMouseEnter",
                        v = "mouse",
                        (l === "pointerout" || l === "pointerover") && (q = Ni,
                        b = "onPointerLeave",
                        y = "onPointerEnter",
                        v = "pointer"),
                        tl = m == null ? o : za(m),
                        ...
                        o.relatedTarget = d,
                        b = null,
                        Bu(S) === h && (q = new q(y,v + "enter",B,u,S),
                        q.target = d,
                        q.relatedTarget = tl,
                        b = q),
                        tl = b,
                ...
                l: {
                    ...
                    m === "select" || m === "input" && o.type === "file")
                        ...
                        m = o.nodeName,
                        !m || m.toLowerCase() !== "input" || o.type !== "checkbox" && o.type !== "radio" ? h && Wn(h.elementType) && (D = Qi) : D = fd;
                    if (D && (D = D(l, h))) {
                        xi(T, D, u, S);
                        break l
                    }
                    Z && Z(l, o, h),
                    l === "focusout" && h && o.type === "number" && h.memoizedProps.value != null && wn(o, "number", o.value)
                }
                switch (Z = h ? za(h) : window,
                l) {
                case "focusin":
                    (Xi(Z) || Z.contentEditable === "true") && (Ku = Z,
                    sf = h,
                    qa = null);
                    break;
                case "focusout":
                ...
                p && (qi && u.locale !== "ko" && (Lu || p !== "onCompositionStart" ? p === "onCompositionEnd" && Lu && (R = Di()) : (Lt = S,
                Pn = "value"in Lt ? Lt.value : Lt.textContent,
                Lu = !0)),
                Z = bn(h, p),
                0 < Z.length && (p = new Hi(p,l,null,u,S),
                T.push({
                    event: p,
                    listeners: Z
                }),
                R ? p.data = R : (R = Gi(u),
                R !== null && (p.data = R)))),
                (R = Py ? ld(l, u) : td(l, u)) && (p = bn(h, "onBeforeInput"),
                0 < p.length && (Z = new Hi("onBeforeInput","beforeinput",null,u,S),
                T.push({
                    event: Z,
                    listeners: p
                }),
    ...
    function Tv(l, t, u, a, e) {
        for (var n = t._reactName, f = []; u !== null && u !== a; ) {
            ...
            e ? (h = Oa(u, n),
            h != null && f.unshift(fe(u, h, i))) : e || (h = Oa(u, n),
            h != null && f.push(fe(u, h, i)))),
            u = u.return
        }
        f.length !== 0 && l.push({
            event: t,
...
`).replace(kd, "")
    ...
    function ll(l, t, u, a, e, n) {
        ...
        case "formAction":
            if (typeof a == "function") {
                ...
                typeof n == "function" && (u === "formAction" ? (t !== "input" && ll(l, t, "name", e.name, e, null),
                ll(l, t, "formEncType", e.formEncType, e, null),
                ll(l, t, "formMethod", e.formMethod, e, null),
                ll(l, t, "formTarget", e.formTarget, e, null)) : (ll(l, t, "encType", e.encType, e, null),
        ...
        default:
            if (Wn(t)) {
                for (S in u)
                    ...
                    a !== void 0 && pc(l, t, S, a, u, void 0));
                return
            }
        }
        for (c in u)
            u.hasOwnProperty(c) && (a = u[c],
            a != null && ll(l, t, c, a, u, null))
    }
    function Fd(l, t, u, a) {
        switch (t) {
        case "div":
        ...
        case "select":
            ...
            u = f,
            a = m,
            o != null ? ju(l, !!u, o, !1) : !!a != !!u && (t != null ? ju(l, !!u, t, !0) : ju(l, !!u, u ? [] : "", !1));
            return;
        case "textarea":
            m = o = null;
            for (c in u)
        ...
        case "menuitem":
            for (var q in u)
                o = u[q],
                u.hasOwnProperty(q) && o != null && !a.hasOwnProperty(q) && ll(l, t, q, null, a, o);
            for (h in a)
                if (o = a[h],
                m = u[h],
        ...
        default:
            if (Wn(t)) {
                for (var tl in u)
                    o = u[tl],
                    u.hasOwnProperty(tl) && o !== void 0 && !a.hasOwnProperty(tl) && pc(l, t, tl, void 0, a, o);
                for (S in a)
                    o = a[S],
                    m = u[S],
                    !a.hasOwnProperty(S) || o === m || o === void 0 && m === void 0 || pc(l, t, S, o, a, m);
                return
            }
        }
        for (var y in u)
            o = u[y],
            u.hasOwnProperty(y) && o != null && !a.hasOwnProperty(y) && ll(l, t, y, null, a, o);
        for (T in a)
            o = a[T],
            m = u[T],
            !a.hasOwnProperty(T) || o === m || o == null && m == null || ll(l, t, T, o, a, m)
    }
    var Yc = null
      , Bc = null;
    function En(l) {
    ...
    var _v = typeof setTimeout == "function" ? setTimeout : void 0
      ...
      , l1 = typeof queueMicrotask == "function" ? queueMicrotask : typeof Mv < "u" ? function(l) {
                    ...
                    if (0 < a && 8 > a) {
                        ...
                        u & 4)
                            ...
                            f = u.firstChild; f; ) {
                                var c = f.nextSibling
                                  , i = f.nodeName;
                                f[Aa] || i === "SCRIPT" || i === "STYLE" || i === "LINK" && f.rel.toLowerCase() === "stylesheet" || u.removeChild(f),
                                f = c
                            }
                    }
                    if (e === 0) {
    ...
    function s1(l, t, u) {
        ...
        if (a && l && t) {
            ...
            t === "image" && u && u.imageSrcSet ? (e += '[imagesrcset="' + at(u.imageSrcSet) + '"]',
            typeof u.imageSizes == "string" && (e += '[imagesizes="' + at(u.imageSizes) + '"]')) : e += '[href="' + at(l) + '"]';
            var n = e;
            switch (t) {
            case "style":
                n = Sa(l);
            ...
            vt.set(n, l),
            a.querySelector(e) !== null || t === "style" && a.querySelector(ie(n)) || t === "script" && a.querySelector(se(n)) || (t = a.createElement("link"),
            Dl(t, "link", l),
            Tl(t),
            a.head.appendChild(t)))
        }
    ...
    function qv(l, t, u, a) {
        ...
        case "title":
            return null;
        case "style":
            return typeof u.precedence == "string" && typeof u.href == "string" ? (t = Sa(u.href),
        ...
        case "link":
            if (u.rel === "stylesheet" && typeof u.href == "string" && typeof u.precedence == "string") {
                ...
                n.set(l, f),
                (n = e.querySelector(ie(l))) && !n._p && (f.instance = n,
                f.state.loading = 5),
                vt.has(l) || (u = {
                    rel: "preload",
                    as: "style",
    ...
    function Bv(l, t, u) {
        ...
        e = 0; e < u.length; e++) {
            var n = u[e];
            if (!(n[Aa] || n[Nl] || l === "link" && n.getAttribute("rel") === "stylesheet") && n.namespaceURI !== "http://www.w3.org/2000/svg") {
    ...
    function xv(l, t, u, a, e, n, f, c, i, h, S, T) {
        return l = new T1(l,t,u,f,c,i,h,T),
        t = 1,
        n === !0 && (t |= 24),
        n = kl(3, null, null, t),
        l.current = n,
    ...
    function O1(l, t, u, a, e) {
        switch (t) {
        case "focusin":
            return cu = oe(cu, l, t, u, a, e),
            !0;
        case "dragenter":
            return iu = oe(iu, l, t, u, a, e),
            !0;
        case "mouseover":
            return su = oe(su, l, t, u, a, e),
            !0;
        case "pointerover":
            var n = e.pointerId;
            return de.set(n, oe(de.get(n) || null, l, t, u, a, e)),
            !0;
        case "gotpointercapture":
    ...
    function me(l) {
        ...
        for (; 0 < vu.length && (u = vu[0],
        u.blockedOn === null); )
            Kv(u),
            u.blockedOn === null && vu.shift();
    ...
    qn.prototype.unmount = $c.prototype.unmount = function() {
        ...
        if (l !== null) {
            ...
            jv(l.current, 2, null, l, null, null),
            hn(),
            t[Yu] = null
        }
    }
...
const ny = "";
function x1() {
    const [_,fl] = jt.useState("")
      , [k,r] = jt.useState(null)
      , [X,K] = jt.useState([])
      , [sl,Ol] = jt.useState(0)
      , [H,E] = jt.useState("");
    jt.useEffect( () => {
        fetch(ny + "/randomPayload").then(Q => Q.json()).then(Q => {
            fl(Q.payload),
            r(Q.seed)
        }
        )
    ...
    ;
    return jt.useEffect( () => {
        _.length > 0 && U === _.length && fetch(ny + "/doneTest", {
            method: "POST",
            body: JSON.stringify({
                startPoint: sl,
                typed: X,
    ...
    _.length === 0 ? ml.jsx("p", {
        children: " Loading... "
    }) : U === _.length ? ml.jsx(ml.Fragment, {
        children: ml.jsxs("p", {
            children: [" ", H.length > 0 ? H : "Loading completion screen...", " "]
        })
    }) : ml.jsxs("div", {
        style: {
            display: "flex",
        ...
        children: [ml.jsx("input", {
            value: "",
            placeholder: "Focus here to begin typing",
            onKeyDown: ul
        }), ml.jsxs("div", {
            style: {
            ...
            children: [ml.jsx("span", {
                style: {
                    color: "green"
                },
                children: U > 0 ? _.slice(0, U) : ""
            }), ml.jsx("span", {
                style: {
                ...
                children: _.slice(U + 1)
            })]
        })]
    })
}
function Q1() {
    const [_,fl] = jt.useState(Math.random());
    return ml.jsx(ml.Fragment, {
        children: ml.jsxs("div", {
            style: {
                position: "absolute",
                display: "flex",
                flexDirection: "column",
            ...
            children: [ml.jsxs("div", {
                ...
                children: [ml.jsx("h2", {
                    children: "Goose's Typing Test"
                }), ml.jsx("p", {
                    children: "Start typing to begin!"
                }), ml.jsx("button", {
                    onClick: () => fl(Math.random()),
                    children: "Restart"
                })]
            }), ml.jsx(x1, {}, _), ml.jsx("span", {})]
        })
    })
}
X1.createRoot(document.getElementById("root")).render(ml.jsx(jt.StrictMode, {
    children: ml.jsx(Q1, {})
}));
